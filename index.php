...
<head>
    ...
    <style>
        .product__item {
            ...
            position: relative; /* Positioning for overlay elements */
        }
                            ...
                            <li class="drop-down2">
                                ...
                                <?php if ($customerID !== 'login'): ?>
                                    ...
                                    <ul id="dropdownMenu" class="dropdown-menu2">
                                        ...
                                        <li><a href="registrationFront.php">Sign out</a></li> <!-- تعديل تسجيل الخروج -->
                                    </ul>
                                <?php endif; ?>
                            </li>
...
<!-- Hero Section Begin -->
<section class="hero" style="margin-top: 60px; position: relative; overflow: hidden;">
    <div class="hero__slider owl-carousel">
        <div class="hero__item set-bg" data-setbg="img/hero/cup.jpg" style="background-size: cover;">
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="hero__text ccc">
                            <h2 style="font-family: 'scr' !important; font-size: 55px">Cooking. Tasting. Living.</h2>
                            <a href="shop.php" class="primary-btn" style="font-family: 'scr' !important; font-size: 30px">Check Our Menu</a>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="hero__item set-bg" data-setbg="img/hero/c2.jpg">
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="hero__text ccc">
        ...
        <div class="hero__item set-bg" data-setbg="img/hero/doo.jpg">
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="hero__text ccc">
        ...
        <div class="hero__item set-bg" data-setbg="img/hero/coo.jpg">
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="hero__text ccc">
    ...
    <div style="position: absolute; top:700px;  width: 100%; z-index: 3;">
        ...
        <svg id="" preserveAspectRatio="xMidYMax meet" class="svg-separator sep3" viewBox="0 0 1600 100" style="display: block;  data-height:auto ;  width:100%; position: absolute ;bottom: 0; left: 0;  right: 0;" >
            ...
            <path class="" style="opacity: 1;fill: #F3F3F3;" d="M-40,83.627C20.307,83.627,20.058,44,80,44s60.003,40,120,40s59.948-40,120-40s60.313,40,120,40s60.258-40,120-40s60.202,40,120,40s60.147-40,120-40s60.513,40,120,40s60.036-40,120-40c59.964,0,60.402,40,120,40s59.925-40,120-40s60.291,40,120,40s60.235-40,120-40s60.18,40,120,40s59.82,0,59.82,0l0.18,14H-60V84L-40,83.627z"></path>
            <path class="" style="fill: rgb(243,243,243);" d="M-40,95.627C20.307,95.627,20.058,56,80,56s60.003,40,120,40s59.948-40,120-40s60.313,40,120,40s60.258-40,120-40s60.202,40,120,40s60.147-40,120-40s60.513,40,120,40s60.036-40,120-40c59.964,0,60.402,40,120,40s59.925-40,120-40s60.291,40,120,40s60.235-40,120-40s60.18,40,120,40s59.82,0,59.82,0l0.18,138H-60V96L-40,95.627z"></path></svg>
...
<section><div class="categories">
        <div class="container">
            <div class="row">
                <div><h4 style="text-align: center; margin-bottom: 20px; font-size: 60px; color: #e37b97; font-family: 'scr' !important;">Shop</h4></div>

                <div class="categories__slider owl-carousel">
                    <a href="shop.php?category=Catering" class="categories__item">
                        <div class="categories__item__icon">
                            <img src="img/icon/catring.png" alt="Catering Icon" style="width: 50px; height: 50px;">
                            <h5>Catering</h5>
                        </div>
                    </a>
                    <a href="shop.php?category=Flowers" class="categories__item">
                        <div class="categories__item__icon">
                            <img src="img/icon/flower.png" alt="Flowers Icon" style="width: 50px; height: 50px;">
                            <h5>Flowers</h5>
                        </div>
                    </a>

                    <a href="shop.php?category=Cheese Cake" class="categories__item">
                        <div class="categories__item__icon">
                            <img src="img/icon/chease.png" alt="Cheese Cake Icon" style="width: 50px; height: 50px;">
                            <h5>Cheese Cake</h5>
                        </div>
                    </a>
                    <a href="shop.php?category=Mini Cake" class="categories__item">
                        <div class="categories__item__icon">
                            <img src="img/icon/mini.png" alt="Mini Cake Icon" style="width: 50px; height: 50px;">
                            <h5>Mini Cake</h5>
                        </div>
                    </a>
                    <a href="shop.php?category=Ready Cakes" class="categories__item">
                        <div class="categories__item__icon">
                            <img src="img/icon/cak.png" alt="Ready Cakes Icon" style="width: 50px; height: 50px;">
                            <h5>Ready Cakes</h5>
                        </div>
                    </a>
                </div>
...
<section class="product spad" style="position: relative; overflow: hidden;">
    <div class="container">
        <h4 style="text-align: center; margin-bottom: 20px; font-size: 60px; color: #e37b97; font-family: 'scr' !important;">
            Best Rating
        </h4>
        <div class="product__carousel owl-carousel owl-theme">
            ...
            // Query to fetch products with rating greater than 4
            $stmt = $pdo->prepare("SELECT * FROM product WHERE preview > 4");
            $stmt->execute();
            ...
            if ($products) {
                foreach ($products as $product) {
                    ...
                    echo '        <img src="' . htmlspecialchars($product['imagesID'], ENT_QUOTES, 'UTF-8') . '" alt="' . htmlspecialchars($product['productName'], ENT_QUOTES, 'UTF-8') . '">';
                    echo '    </div>';
                    echo '    <div class="product__item__text">';
                    echo '        <h5>' . htmlspecialchars($product['productName'], ENT_QUOTES, 'UTF-8') . '</h5>';
                    echo '        <div class="cart_add">';
                    echo '            <a href="shop-details.php?productID=' . urlencode($product['productID']) . '">Quick View</a>';
                    echo '        </div>';
                    echo '    </div>';
                    echo '</div>';
                }
    ...
    <div style="position: absolute; width: 100%; z-index: 3; bottom: 0;">
        <svg id="" preserveAspectRatio="xMidYMax meet" class="svg-separator sep3" viewBox="0 0 1600 100" style="display: block; width: 100%; position: absolute; bottom: 0; left: 0; right: 0;">
            <path class="" style="opacity: 1; fill: #F4E2E2FF;" d="M-40,71.627C20.307,71.627,20.058,32,80,32s60.003,40,120,40s59.948-40,120-40s60.313,40,120,40s60.258-40,120-40s60.202,40,120,40s60.147-40,120-40s60.513,40,120,40s60.036-40,120-40c59.964,0,60.402,40,120,40s59.925-40,120-40s60.291,40,120,40s60.235-40,120-40s60.18,40,120,40s59.82,0,59.82,0l0.18,26H-60V72L-40,71.627z"></path>
            <path class="" style="opacity: 1; fill: #F4E2E2FF;" d="M-40,83.627C20.307,83.627,20.058,44,80,44s60.003,40,120,40s59.948-40,120-40s60.313,40,120,40s60.258-40,120-40s60.202,40,120,40s60.147-40,120-40s60.513,40,120,40s60.036-40,120-40c59.964,0,60.402,40,120,40s59.925-40,120-40s60.291,40,120,40s60.235-40,120-40s60.18,40,120,40s59.82,0,59.82,0l0.18,14H-60V84L-40,83.627z"></path>
...
<section class="instagram spad" style="position: relative; overflow: hidden;">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 p-0">
                <div class="instagram__text">
                    ...
                    <h5 style=" font-family: 'scr' !important; font-size: 26px !important;"><i class="fa fa-instagram" ></i >@CaramellaCake</h5>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                        <div class="instagram__pic middle__pic">
                            <img src="img/instagram/5-2.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                        <div class="instagram__pic">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                        <div class="instagram__pic middle__pic">
                            <img src="img/instagram/8-1.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                        <div class="instagram__pic">
                            <img src="img/instagram/10.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
