...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($productName) || empty($productCategory) || empty($productPrice) || empty($productDescription)) {
        ...
        for ($i = 0; $i < count($_FILES['images']['name']); $i++) {
            if ($_FILES['images']['error'][$i] === UPLOAD_ERR_OK) {
                ...
                if (move_uploaded_file($imageTmpName, $imagePath)) {
                    ...
                    $error = "Failed to upload image " . $imageName;
                    break;
                }
            }
        }
        ...
        if (empty($error)) {
            ...
            $stmt = $conn->prepare("INSERT INTO product (productName, price, description, category, imagesID, imageID2, imageID3, imageID4, imageID5, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

            if ($stmt === false) {
                die("Error preparing the statement: " . $conn->error);
            }

            // ملء المسارات بحيث يتم إدخال حتى 5 صور، وإذا لم تكن هناك صورة يتم إدخال قيمة فارغة
            $imagePaths = array_pad($imagePaths, 5, '');
            $stmt->bind_param("sdssssssss", $productName, $productPrice, $productDescription, $productCategory, $imagePaths[0], $imagePaths[1], $imagePaths[2], $imagePaths[3], $imagePaths[4], $createdAt);
        ...
        <div class="breadcrumb-option">
            <div class="container">
                ...
                <div style="margin-top: 100px">
                    ...
                    <section class="product-info" style="margin-bottom: 100px; background-color: #ffffff;">
                            ...
                            <div class="container widget">
                                <div class="col-lg-12 col-md-12 col-sm-12 pr-lg-0 wow slideInLeft">
                                    <div class="logincontainer container">
                                        <h3 class="bottom35 text-center text-md-left">Add Product</h3>
                                        ...
                                        <form method="POST" action="" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group bottom35">
                                                        ...
                                                        <input class="form-control" type="text" name="productName" placeholder="Enter product name" value="" required="" id="productName">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group bottom35">
                                                        ...
                                                        <select class="form-control" name="productCategory" id="productCategory" required>
                                                            ...
                                                            <option value="Ready cake">Ready cake</option>
                                                            <option value="Mini cake">Mini cake</option>
                                                            <option value="Decorated cake">Decorated cake</option>
                                                            <option value="Cake pieces">Cake pieces</option>
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group bottom35">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="Enter price" value="" name="productPrice" required="" id="productPrice">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group bottom35">
                                                        ...
                                                        <div id="imageUploadContainer" class="image-upload-container">
                                                            ...
                                                            <div class="add-image-button" onclick="document.getElementById('imageInput').click()">+</div>
                                                            <input id="imageInput" name="images[]" type="file" class="image-input" accept="image/*" onchange="addImage(this)" multiple>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 register-btn text-center">
                                                ...
                                                <button type="submit" class="btn-default-1 py-2 border-0 rounded px-5">Add Product</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<script>
            ...
            Array.from(input.files).forEach(file => {
                if (images.length < maxImages) {
                    ...
                    reader.onload = function(e) {
                        ...
                        <button class="remove-image" onclick="removeImage(this, ${images.length})">X</button>`;
                        document.getElementById('imageUploadContainer').insertBefore(imageBox, document.querySelector('.add-image-button'));
                        images.push(file);

                        // Create a new hidden input element for the added image
                        ...
                        document.querySelector('form').appendChild(newImageInput);
                    };
    ...
    function removeImage(button, index) {
        const imageBox = button.parentElement;
        images.splice(index, 1);
        imageBox.remove();

        // Remove the corresponding hidden input
        const hiddenInputs = document.querySelectorAll('input[type="hidden"][name="images[]"]');
