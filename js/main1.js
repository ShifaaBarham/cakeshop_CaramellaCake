...
(function ($) {
  ...
  try {
    ...
    if (ctx) {
      ...
      // إنشاء ملاحظات ديناميكية للألوان
      var chartNoteWrap = document.getElementById('chart-note-wrap');
      products.forEach(function(label, index) {
        var div = document.createElement('div');
        div.className = 'chart-note mr-0 d-block';
        div.innerHTML = '<span class="dot" style="background-color: ' + productColors[index] + ';"></span><span>' + label + '</span>';
        chartNoteWrap.appendChild(div);
      });
