            ...
            <div class="container">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (empty($productName) || empty($productCategory) || empty($productPrice) || empty($productDescription)) {
                        ...
                        $updateSql = "UPDATE product SET productName = ?, category = ?, price = ?, description = ? WHERE productID = ?";
                            ...
                            <div class="container widget">
                                <div class="col-lg-12 col-md-12 col-sm-12 pr-lg-0 wow slideInLeft">
                                    <div class="logincontainer container">
                                        <h3 class="bottom35 text-center text-md-left">Update Product</h3>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group bottom35">
                                                        ...
                                                        <input class="form-control" type="text" name="productName" placeholder="Enter product name" value="<?php echo htmlspecialchars($product['productName'], ENT_QUOTES, 'UTF-8'); ?>" required="" id="productName">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group bottom35">
                                                        ...
                                                        <select class="form-control" name="productCategory" id="productCategory" required>
                                                            ...
                                                            <option value="Ready cake" <?php if($product['category'] == 'Ready cake') echo 'selected'; ?>>Ready cake</option>
                                                            <option value="Mini cake" <?php if($product['category'] == 'Mini cake') echo 'selected'; ?>>Mini cake</option>
                                                            <option value="Decorated cake" <?php if($product['category'] == 'Decorated cake') echo 'selected'; ?>>Decorated cake</option>
                                                            <option value="Cake pieces" <?php if($product['category'] == 'Cake pieces') echo 'selected'; ?>>Cake pieces</option>
                                                            <option value="Catering" <?php if($product['category'] == 'Catering') echo 'selected'; ?>>Catering</option>
                                                            <option value="Flowers" <?php if($product['category'] == 'Flowers') echo 'selected'; ?>>Flowers</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group bottom35">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="Enter price" value="<?php echo htmlspecialchars($product['price'], ENT_QUOTES, 'UTF-8'); ?>" name="productPrice" required="" id="productPrice">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group bottom35">
                                                        ...
                                                        <textarea class="form-control" name="productDescription" id="productDescription" placeholder="Enter product description" required=""><?php echo htmlspecialchars($product['description'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 register-btn text-center">
                                                <button type="submit" class="btn-default-1 py-2 border-0 rounded px-5">Update Product</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
